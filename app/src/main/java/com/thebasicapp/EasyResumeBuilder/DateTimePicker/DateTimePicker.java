package com.thebasicapp.EasyResumeBuilder.DateTimePicker;
...
//			inflater.inflate(R.layout.datetimepicker, this, true);
		...
		public void initData() {
			...
			month_display.setText("1");
			date_display.setText("1");
			year_display.setText("1"); 
		...
		private void initFilterNumericDigit() {
			...
			try {
				date_display.setFilters(new InputFilter[] { new InputFilterMinMax(
						0, cal.getActualMaximum(Calendar.DAY_OF_MONTH)) });
				if(check == 0){
					date_display.setText("0");
					check = 1;
				}
				InputFilter[] filterArray_year = new InputFilter[1];
				filterArray_year[0] = new InputFilter.LengthFilter(2);
		...
		View.OnClickListener year_plus_listener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					date_display.requestFocus();
					String year_now = year_display.getText().toString();
					if(year_now.equals("20")){
						year_display.setText("0");
						cal.set(Calendar.YEAR, 0);
						
					}else if(year_now.equals("0")){
					year_display.setText("1");	
		...
		View.OnClickListener year_minus_listener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					String year_now = year_display.getText().toString();
					if(year_now.equals("1")){
						year_display.setText("0");
						cal.set(Calendar.YEAR, 0);
						
					}else if(year_now.equals("0")){
					year_display.setText("20");	
